...
export default function DashboardPage() {
    ...
    return (
        <div className="flex-1 space-y-6 md:space-y-8 pt-4 md:pt-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900">Genel Bakış</h2>
                    <p className="text-sm text-slate-500">İşletmenizin anlık performansı.</p>
                </div>
            </div>
