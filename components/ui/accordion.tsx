...
function AccordionTrigger({
  ...
  triggerPrefix,
  ...props
}: React.ComponentProps<typeof AccordionPrimitive.Trigger> & { actions?: React.ReactNode, triggerPrefix?: React.ReactNode }) {
  return (
    <AccordionPrimitive.Header className="flex items-center">
      {triggerPrefix && <div className="mr-2 flex-shrink-0">{triggerPrefix}</div>}
      ...
      {actions && <div className="ml-2 py-4 flex items-center gap-2">{actions}</div>}
